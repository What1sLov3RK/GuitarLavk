...
class Order(models.Model):
    ...
    telephone = models.CharField(max_length=100, verbose_name="Номер телефону", blank=True, null=True)
    address = models.CharField(max_length=100, verbose_name="Адреса доставки", blank=True, null=True)
